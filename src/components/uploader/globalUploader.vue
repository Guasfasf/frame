        ...
        <div class="file-panel" slot-scope="props" :class="{'collapse': collapse}">
          <div class="file-title">
            ...
            <div class="operate">
              ...
              <el-button @click="close" type="text">
                <span>关闭</span>
              </el-button>
              <el-button @click="clearAll" type="text">
                <span>清空</span>
              </el-button>
            </div>
          </div>
          ...
          <ul class="file-list">
            <li v-for="file in props.fileList" :key="file.id">
              <uploader-file :class="'file_' + file.id" :file="file"></uploader-file>
            </li>
...
const api = {
  // simpleUploadURL: 'http://192.168.14.152:9001/fileService/upload'
  simpleUploadURL: 'http://192.168.110.92:18081/fileService/chunk'
}
export default {
  data () {
    return {
      options: {
        target: api.simpleUploadURL, // 目标上传 URL
        chunkSize: '10240000', // 分块大小
        singleFile: false, // 单文件上传
        directory: false, // 文件夹上传
        fileParameterName: 'file', // 上传文件时文件的参数名，默认file  upfile
